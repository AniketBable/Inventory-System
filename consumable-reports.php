...
<?php
	...
	if(isset($_GET['del_consumable_id']))
	 {
		$delete_id = $_GET['del_consumable_id'];		
		
		$db->delete_consumable_full_details_by_id($delete_id);
		$common_msg	=	"Consumable record deleted successfully.";
	 }
...
<head>
    <title>Inventory System |  Consumable Reports  </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Consumable Reports</h5>
                                            <p class="text-muted m-b-10">You can view all Consumable below..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="add-consumable-details.php">Add Consumable</a>
                                                </li>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>All Consumables Details By Multi-Column Ordering</h5>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_consumables_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/view-consumable-details.php?consumable-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">View</a></td>
																		 
																		<td><a href="/edit-consumable-details.php?consumable-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/consumable-reports.php?del_consumable_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
