	...
	if(isset($_GET['del_computerperipherals_id']))
	 {
		...
		$db->delete_computerperipherals_full_details_by_id($delete_id);
		$common_msg	=	" Computer & Peripherals record deleted successfully.";
	 }
...
<head>
    <title>Inventory System |  Computer & Peripherals Reports  </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            ...
                                            <p class="text-muted m-b-10">You can view all  Computer & Peripherals below..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="add-computer&peripherals-details.php">Add  Computer & Peripherals</a>
                                                </li>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_computerperipherals_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/view-computer&peripherals-details.php?computerperipherals-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">View</a></td>
																		 
																		<td><a href="/edit-computer&peripherals-details.php?computerperipherals-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/computer&peripherals-reports.php?del_computerperipherals_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
