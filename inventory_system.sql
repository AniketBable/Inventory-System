...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2018 at 09:08 AM
...
CREATE TABLE `books&journals_full_details` (
  ...
  `Quantity Accepted` int(11) NOT NULL,
...
(4, '21', '2112', 'Koala.jpg', '21', 'Chrysanthemum.jpg', 'wadasd', 'dasda', '12', '12', '21', '21', '11', '222', '2018-02-26', '20:11:36');
...
INSERT INTO `equipments_full_details` (`id`, `Description Of Material`, `Quantity Accepted`, `Department`, `Staff Name`, `Lab No.`, `Date`, `Quantity`, `Remaining`) VALUES
(2, 'dasda', 21, 'Comp', 'gart', 352, '21021999', 5, 16);
...
--
-- Table structure for table `studentsuniform_full_details`
--

CREATE TABLE `studentsuniform_full_details` (
  `id` int(11) NOT NULL,
  `Description Of Material` text NOT NULL,
  `Quantity Accepted` int(11) NOT NULL,
  `Department` text NOT NULL,
...
--
-- Dumping data for table `workshopmaterial_full_details`
--

INSERT INTO `workshopmaterial_full_details` (`id`, `Description Of Material`, `Quantity Accepted`, `Department`, `Staff Name`, `Lab No.`, `Date`, `Quantity`, `Remaining`) VALUES
(2, 'dwawdawd', 222, 'Comp', 'sdas', 0, '122', 112, 11);
...
--
-- Indexes for table `studentsuniform_full_details`
--
ALTER TABLE `studentsuniform_full_details`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `studentsuniform_full_details`
--
ALTER TABLE `studentsuniform_full_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
