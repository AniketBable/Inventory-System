...
<?php
	...
	$common_msg1="";
	 ...
	 if(isset($_GET['consumable-id']))
	 {
		$consumable_id = $_GET['consumable-id'];		
	...
	$consumable_data		=	$db->fetch_consumable_full_details_by_id($consumable_id);
	...
	$result_id					=	$consumable_data[0];
	$result_g_no				=	$consumable_data[1];
	$result_challan 			=	$consumable_data[2];
	$result_bill         		=	$consumable_data[3];
	$result_supplier			=	$consumable_data[4];
	$result_description			=	$consumable_data[5];
	$result_unit				=	$consumable_data[6];
	$result_received 			=	$consumable_data[7];
	$result_rejected	    	=	$consumable_data[8];
	$result_accepted			=	$consumable_data[10];
	$result_total	 			=	$consumable_data[11];
	$result_date				=	$consumable_data[12];
	$result_time				=	$consumable_data[13];
	...
	if(isset($_POST['edit']))
	{
		...
		$total			=	$_POST['total'];
			...
			if($db->update_consumable_full_details_by_id($g_no,$challan,$bill,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$consumable_id))
			{
					  $common_msg	=	"Consumable Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Consumable Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Consumable Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Consumable Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="consumable-reports.php">Consumable Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-consumable-details.php">Edit Consumable</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Edit Consumable</h5>
                                                        <span>Please fill the Consumable details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="consumable-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
