...
<?php
	...
	$equipments_data		=	$db->fetch_equipments_stock_details_by_id($equipments_id);
	...
	$result_supply_order		=	$equipments_data[1];
	$result_bill				=	$equipments_data[2];
	$result_D_C					=	$equipments_data[3];
	$result_supplier			=	$equipments_data[4];
	$result_description			=	$equipments_data[5];
	$result_received			=	$equipments_data[6];
	$result_amount				=	$equipments_data[7];
	$result_total				=	$equipments_data[8];
	$result_department			=	$equipments_data[9];
	$result_staff_name			=	$equipments_data[10];
	$result_lab_no				=	$equipments_data[11];
	$result_date				=	$equipments_data[12];
	$result_given_quantity		=	$equipments_data[13];
	$result_remaining_quantity	=	$equipments_data[14];
	...
	if(isset($_POST['update-entry']))
	{
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];  
			...
			if($db->update_equipments_stock_details_by_id($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity,$equipments_id))	
			{
					  $common_msg	=	"Equipments Stock Details Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Equipments Stock Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Equipments Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Equipments Stock Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="view-equipments-details.php">Equipments Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-equipments-stock-details.php">Edit Equipments Stock</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Edit Equipments Stock</h5>
                                                        <span>Please fill the Equipments Stock details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="view-equipments-details.php" class="btn btn-primary">Back</a>
                                                                </div>
