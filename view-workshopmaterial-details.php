...
<?php
	...
	$common_msg1="";
	 ...
	 if(isset($_GET['workshopmaterial-id']))
	 {
		$workshopmaterial_id = $_GET['workshopmaterial-id'];		
		$_SESSION['workshopmaterial_id'] = $workshopmaterial_id;
	 }
	 else if(isset($_SESSION['workshopmaterial_id']))
	 {
		 $workshopmaterial_id = $_SESSION['workshopmaterial_id'];
	 }
	...
	$workshopmaterial_data		=	array();
	$workshopmaterial_data		=	$db->fetch_workshopmaterial_full_details_by_id($workshopmaterial_id);
	...
	if(!empty($workshopmaterial_data))
	{	
		 
	$result_id					=	$workshopmaterial_data[0];
	$result_g_no				=	$workshopmaterial_data[1];
	$result_challan 			=	$workshopmaterial_data[2];
	$result_challan_image  		=	$workshopmaterial_data[3];
	$result_bill				=	$workshopmaterial_data[4];
	$result_bill_image			=	$workshopmaterial_data[5];
	$result_supplier			=	$workshopmaterial_data[6];
	$result_description			=	$workshopmaterial_data[7];
	$result_unit				=	$workshopmaterial_data[8];
	$result_received 			=	$workshopmaterial_data[9];
	$result_rejected	    	=	$workshopmaterial_data[10];
	$result_accepted			=	$workshopmaterial_data[11];
	$result_amount				=	$workshopmaterial_data[12];
	$result_total	 			=	$workshopmaterial_data[13];
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_workshopmaterial_full_details($description,$accepted,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Workshop Material Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
	...
	if(isset($_GET['del_workshopmaterial_id']))
	 {
		$delete_id = $_GET['del_workshopmaterial_id'];		
		
		$db->delete_workshopmaterial_details_by_id($delete_id);
		$common_msg	=	"Workshop Material record deleted successfully.";
	 }
...
<head>
    <title> Admin |   Workshop Material Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Workshop Material Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Workshop Material Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="workshopmaterial-reports.php">Workshop Material Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-workshopmaterial-details.php">Workshop Material Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5> Workshop Material Details</h5>
                                                        <span>Please fill the Workshop Material Details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="workshopmaterial-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_workshopmaterial_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-workshopmaterial-details.php?workshopmaterial-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-workshopmaterial-details.php?del_workshopmaterial_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
