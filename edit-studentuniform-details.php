...
<?php
	...
	$result_bill         		=	$studentuniform_data[3];
	$result_supplier			=	$studentuniform_data[4];
	$result_description			=	$studentuniform_data[5];
	$result_unit				=	$studentuniform_data[6];
	$result_received 			=	$studentuniform_data[7];
	$result_rejected	    	=	$studentuniform_data[8];
	$result_accepted			=	$studentuniform_data[9];
	$result_amount				=	$studentuniform_data[10];
	$result_total	 			=	$studentuniform_data[11];
	$result_date				=	$studentuniform_data[12];
	$result_time				=	$studentuniform_data[13];
	...
	if(isset($_POST['edit']))
	{
		...
		$total			=	$_POST['total'];
			...
			if($db->update_studentuniform_full_details_by_id($g_no,$challan,$bill,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$studentuniform_id))
			{
					  $common_msg	=	"Students Uniform Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Students Uniform Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Students Uniform Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Students Uniform Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="studentuniform-reports.php">Students Uniform Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-studentuniform-details.php">Edit Students Uniform</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Edit Students Uniform</h5>
                                                        <span>Please fill the Students Uniform details..</span>
                                                    </div>
