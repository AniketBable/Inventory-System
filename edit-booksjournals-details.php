...
<?php
	...
	$result_bill         		=	$booksjournals_data[3];
	$result_supplier			=	$booksjournals_data[4];
	$result_description			=	$booksjournals_data[5];
	$result_unit				=	$booksjournals_data[6];
	$result_received 			=	$booksjournals_data[7];
	$result_rejected	    	=	$booksjournals_data[8];
	$result_accepted			=	$booksjournals_data[9];
	$result_amount				=	$booksjournals_data[10];
	$result_total	 			=	$booksjournals_data[11];
	$result_date				=	$booksjournals_data[12];
	$result_time				=	$booksjournals_data[13];
	...
	if(isset($_POST['edit']))
	{
		...
		$total			=	$_POST['total'];
			...
			if($db->update_booksjournals_full_details_by_id($g_no,$challan,$bill,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$booksjournals_id))
			{
					  $common_msg	=	"Books & Journals Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Books & Journals Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Books & Journals Details</h5>
                                            ...
                                            <ul class="breadcrumb-title b-t-default p-t-10">
												...
												<li class="breadcrumb-item"><a href="edit-booksjournals-details.php">Edit Books & Journals</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
