...
<?php
	...
	$common_msg1="";
	 ...
	 if(isset($_GET['del_booksjournals_id']))
	 {
		$delete_id = $_GET['del_booksjournals_id'];		
		
		$db->delete_booksjournals_details_by_id($delete_id);
		$common_msg	=	"Books & Journals record deleted successfully.";
	 }
	 
	 if(isset($_GET['booksjournals-id']))
	 {
		$booksjournals_id = $_GET['booksjournals-id'];		
		$_SESSION['booksjournals_id'] = $booksjournals_id;
	 }
	 else if(isset($_SESSION['booksjournals_id']))
	 {
		 $booksjournals_id = $_SESSION['booksjournals_id'];
	 }
	...
	$booksjournals_data		=	array();
	$booksjournals_data		=	$db->fetch_booksjournals_full_details_by_id($booksjournals_id);
	...
	if(!empty($booksjournals_data))
	{	
		 
	$result_id					=	$booksjournals_data[0];
	$result_g_no				=	$booksjournals_data[1];
	$result_challan 			=	$booksjournals_data[2];
	$result_challan_image  		=	$booksjournals_data[3];
	$result_bill				=	$booksjournals_data[4];
	$result_bill_image			=	$booksjournals_data[5];
	$result_supplier			=	$booksjournals_data[6];
	$result_description			=	$booksjournals_data[7];
	$result_unit				=	$booksjournals_data[8];
	$result_received 			=	$booksjournals_data[9];
	$result_rejected	    	=	$booksjournals_data[10];
	$result_accepted			=	$booksjournals_data[11];
	$result_amount				=	$booksjournals_data[12];
	$result_total	 			=	$booksjournals_data[13];
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_booksjournals_full_details($description,$accepted,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Books & Journals Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Books & Journals Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Books & Journals Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Books & Journals Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="booksjournals-reports.php">Books & Journals Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="view-booksjournals-details.php">Books & Journals Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="booksjournals-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_booksjournals_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-booksjournals-details.php?booksjournals-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-booksjournals-details.php?del_booksjournals_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
