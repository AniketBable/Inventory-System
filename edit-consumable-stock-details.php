...
<?php
	...
	$consumables_data		=	$db->fetch_consumables_stock_details_by_id($consumable_id);
	...
	$result_supply_order		=	$consumables_data[1];
	$result_bill				=	$consumables_data[2];
	$result_D_C					=	$consumables_data[3];
	$result_supplier			=	$consumables_data[4];
	$result_description			=	$consumables_data[5];
	$result_received			=	$consumables_data[6];
	$result_amount				=	$consumables_data[7];
	$result_total				=	$consumables_data[8];
	$result_department			=	$consumables_data[9];
	$result_staff_name			=	$consumables_data[10];
	$result_lab_no				=	$consumables_data[11];
	$result_date				=	$consumables_data[12];
	$result_given_quantity		=	$consumables_data[13];
	$result_remaining_quantity	=	$consumables_data[14];
	...
	if(isset($_POST['update-entry']))
	{
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];
			...
			if($db->update_consumables_stock_details_by_id($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity,$consumable_id))	
			{
					  $common_msg	=	"Consumables Stock Details Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Consumables Stock Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Consumables Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Consumables Stock Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="view-consumable-details.php">Consumables Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-consumable-stock-details.php">Edit Consumables Stock</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Edit Consumables Stock</h5>
                                                        <span>Please fill the Consumables Stock details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="view-consumable-details.php" class="btn btn-primary">Back</a>
                                                                </div>
