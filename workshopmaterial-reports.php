	...
	if(isset($_GET['del_workshopmaterial_id']))
	 {
		...
		$db->delete_workshopmaterial_full_details_by_id($delete_id);
...
<head>
    <title>Inventory System |  Workshop Material Reports  </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Workshop Material Reports</h5>
                                            <p class="text-muted m-b-10">You can view all Workshop Material below..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="add-workshopmaterial-details.php">Add Workshop Material</a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="workshopmaterial-reports">Workshop Material Reports</a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>All Workshop Material By Multi-Column Ordering</h5>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_workshopmaterial_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/view-workshopmaterial-details.php?workshopmaterial-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">View</a></td>
																		...
																		<td><a href="/workshopmaterial-reports.php?del_workshopmaterial_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
