 <?php
	...
	if(isset($_POST['submit_btn']))
	{
		...
		{ 
			...
			$db->set_equipments_details($g_no,$challan,$challan_image_name,$bill,$bill_image_name,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total);	
			$common_msg	=	"Equipments Record Added successfully.";
		}
...
<head>
    <title> Admin | Add Equipments Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Add Equipments Details</h5>
                                            <p class="text-muted m-b-10">You can add your Equipments Details..</p>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Add Equipments Information</h5>
																	...
																	<div class="j-row"> 													  
                                                                        ...
                                                                        <div class="j-span6 j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <span class="j-tooltip j-tooltip-right-top">Enter Quantity Accepted</span>
                                                                            </div>
                                                                        </div>
