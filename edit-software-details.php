...
<?php
	...
	$result_bill         		=	$software_data[3];
	$result_supplier			=	$software_data[4];
	$result_description			=	$software_data[5];
	$result_unit				=	$software_data[6];
	$result_received 			=	$software_data[7];
	$result_rejected	    	=	$software_data[8];
	$result_accepted			=	$software_data[9];
	$result_amount				=	$software_data[10];
	$result_total	 			=	$software_data[11];
	$result_date				=	$software_data[12];
	$result_time				=	$software_data[13];
	...
	if(isset($_POST['edit']))
	{
		...
		$total			=	$_POST['total'];
			...
			if($db->update_software_full_details_by_id($g_no,$challan,$bill,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$software_id))
			{
					  $common_msg	=	"Software Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Software Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Software Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Software Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="software-reports.php">Software Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-software-details.php">Edit Software</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
