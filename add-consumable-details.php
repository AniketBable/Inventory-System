 <?php
	...
	if(isset($_POST['submit_btn']))
	{
		...
		{ 
			...
			$db->set_consumables_details($g_no,$challan,$challan_image_name,$bill,$bill_image_name,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total);	
			$common_msg	=	"Consumables Record Added successfully.";
		}
...
<head>
    <title> Admin | Add Consumable Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Add Consumables Details</h5>
                                            <p class="text-muted m-b-10">You can add your Consumables Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                 <li class="breadcrumb-item"><a href="add-consumable-details.php">Add Consumables Details</a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="consumable-reports.php">Consumables Reports</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
