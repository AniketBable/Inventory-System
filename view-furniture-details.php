...
<?php
	...
	if(isset($_GET['del_furniture_id']))
	 {
		$delete_id = $_GET['del_furniture_id'];		
		
		$db->delete_furniture_stock_details_by_id($delete_id);
		$common_msg	=	"Furniture record deleted successfully.";
	 }
	
	 if(isset($_GET['furniture-id']))
	 {
		$furniture_id = $_GET['furniture-id'];		
		$_SESSION['furniture_id'] = $furniture_id;
	 }
	 else if(isset($_SESSION['furniture_id']))
	 {
		 $furniture_id = $_SESSION['furniture_id'];
	 }
	...
	$furniture_data		=	$db->fetch_furniture_full_details_by_id($furniture_id);
	...
	if(!empty($furniture_data))
	{	
		 
	$result_id					=	$furniture_data[0];
	$result_g_no				=	$furniture_data[1];
	$result_challan 			=	$furniture_data[2];
	$result_challan_image  		=	$furniture_data[3];
	$result_bill				=	$furniture_data[4];
	$result_bill_image			=	$furniture_data[5];
	$result_supplier			=	$furniture_data[6];
	$result_description			=	$furniture_data[7];
	$result_unit				=	$furniture_data[8];
	$result_received 			=	$furniture_data[9];
	$result_rejected	    	=	$furniture_data[10];
	$result_accepted			=	$furniture_data[11];
	$result_amount				=	$furniture_data[12];
	$result_total	 			=	$furniture_data[13];
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_furniture_full_details($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Furniture Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin |  Furniture Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Furniture Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Furniture Stock Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="furniture-reports.php">Furniture Stock Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="view-furniture-details.php">Furniture Stock Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5> Furniture Stock Details</h5>
                                                        <span>Please fill the Furniture Stock Details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="furniture-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
													 	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
															<script type="text/javascript">
																  ...
																  $("#btnExport").click(function(e) {
																	...
																	a.download = 'Furniture Report.xls';
																	a.click();
																  });
																});
															</script>
                                                        ...
                                                        <div class="dt-responsive table-responsive" id="table_wrapper">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_furniture_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-furniture-stock-details.php?furniture-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-furniture-details.php?del_furniture_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
