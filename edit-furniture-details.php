...
<?php
	...
	$result_bill         		=	$furniture_data[3];
	$result_supplier			=	$furniture_data[4];
	$result_description			=	$furniture_data[5];
	$result_unit				=	$furniture_data[6];
	$result_received 			=	$furniture_data[7];
	$result_rejected	    	=	$furniture_data[8];
	$result_accepted			=	$furniture_data[9];
	$result_amount				=	$furniture_data[10];
	$result_total	 			=	$furniture_data[11];
	$result_date				=	$furniture_data[12];
	$result_time				=	$furniture_data[13];
	...
	if(isset($_POST['edit']))
	{
		...
		$total			=	$_POST['total'];
			...
			if($db->update_furniture_full_details_by_id($g_no,$challan,$bill,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$furniture_id))
			{
					  $common_msg	=	"Furniture Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Furniture Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Furniture Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Furniture Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="software-reports.php">Furniture Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-software-details.php">Edit Furniture</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <span>Please fill the Furniture details..</span>
                                                    </div>
