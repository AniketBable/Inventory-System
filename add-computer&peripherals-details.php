 <?php
	...
	if(isset($_POST['submit_btn']))
	{
		...
		{ 
			...
			$db->set_computerperipherals_details($g_no,$challan,$challan_image_name,$bill,$bill_image_name,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total);	
			$common_msg	=	"Computer & Peripherals  Record Added successfully.";
		}
...
<head>
    <title> Admin | Add Computer & Peripherals Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Add Website Blogs</h5>
                                            <p class="text-muted m-b-10">You can add your website blogs..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                 <li class="breadcrumb-item"><a href="set_computer&peripherals_details">Add Computer & Peripherals</a>
                                                </li>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Add Computer & Peripherals</h5>
