...
<?php
	...
	if(isset($_GET['del_software_id']))
	 {
		$delete_id = $_GET['del_software_id'];		
		
		$db->delete_software_stock_details_by_id($delete_id);
		$common_msg	=	"Software record deleted successfully.";
	 }
	...
	$software_data		=	array();
	$software_data		=	$db->fetch_software_full_details_by_id($software_id);
	...
	$result_g_no				=	$software_data[1];
	$result_challan 			=	$software_data[2];
	$result_challan_image  		=	$software_data[3];
	$result_bill				=	$software_data[4];
	$result_bill_image			=	$software_data[5];
	$result_supplier			=	$software_data[6];
	$result_description			=	$software_data[7];
	$result_unit				=	$software_data[8];
	$result_received 			=	$software_data[9];
	$result_rejected	    	=	$software_data[10];
	$result_accepted			=	$software_data[11];
	$result_amount				=	$software_data[12];
	$result_total	 			=	$software_data[13];
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_software_full_details($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Software Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin |   Software Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Software Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Software Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="software-reports.php">Software Stock Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="view-software-details.php">Software Stock Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <span>Please fill the Software Details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="software-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
													 	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
															<script type="text/javascript">
																  ...
																  $("#btnExport").click(function(e) {
																	...
																	a.download = 'Software Report.xls';
																	a.click();
																  });
																});
															</script>
                                                        ...
                                                        <div class="dt-responsive table-responsive" id="table_wrapper">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_software_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-software-stock-details.php?software-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-software-details.php?del_software_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
