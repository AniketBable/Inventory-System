...
<?php
	...
	$computerperipherals_data		=	$db->fetch_computerperipherals_stock_details_by_id($computerperipherals_id);
	...
	$result_supply_order		=	$computerperipherals_data[1];
	$result_bill				=	$computerperipherals_data[2];
	$result_D_C					=	$computerperipherals_data[3];
	$result_supplier			=	$computerperipherals_data[4];
	$result_description			=	$computerperipherals_data[5];
	$result_received			=	$computerperipherals_data[6];
	$result_amount				=	$computerperipherals_data[7];
	$result_total				=	$computerperipherals_data[8];
	$result_department			=	$computerperipherals_data[9];
	$result_staff_name			=	$computerperipherals_data[10];
	$result_lab_no				=	$computerperipherals_data[11];
	$result_date				=	$computerperipherals_data[12];
	$result_given_quantity		=	$computerperipherals_data[13];
	$result_remaining_quantity	=	$computerperipherals_data[14];
	...
	if(isset($_POST['update-entry']))
	{
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];
			...
			if($db->update_computerperipherals_stock_details_by_id($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity,$computerperipherals_id))	
			{
					  $common_msg	=	"Computer Peripherals Stock Details Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Computer Peripherals Stock Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Computer Peripherals Stock Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Computer Peripherals Stock Stock Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="view-computer&peripherals-details.php">Computer Peripherals Stock Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-computer&peripherals-stock-details.php">Edit Computer Peripherals Stock Stock</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Edit Computer Peripherals Stock</h5>
                                                        <span>Please fill the Computer Peripherals Stock details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="view-computer&peripherals-details.php" class="btn btn-primary">Back</a>
                                                                </div>
