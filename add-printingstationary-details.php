 <?php
	...
	if(isset($_POST['submit_btn']))
	{
		...
		{ 
			...
			$db->set_printingstationary_details($g_no,$challan,$challan_image_name,$bill,$bill_image_name,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total);	
			$common_msg	=	"Printing Stationary Record Added successfully.";
		}
...
<head>
    <title> Admin | Add Printing Stationary Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            ...
                                            <p class="text-muted m-b-10">You can add your Printing Stationary Details..</p>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Add Printing Stationary Information</h5>
