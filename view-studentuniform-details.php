...
<?php
	...
	$common_msg	="";
	$common_msg1="";
	 if(isset($_GET['del_studentuniform_id']))
	 {
	 $delete_id = $_GET['del_studentuniform_id'];		
		
	 $db->delete_studentuniform_details_by_id($delete_id);
	 $common_msg	=	"Student Uniform record deleted successfully.";
	 }
	 if(isset($_GET['studentuniform-id']))
	 {
		$studentuniform_id = $_GET['studentuniform-id'];		
		$_SESSION['studentuniform_id'] = $studentuniform_id;
	 }
	 else if(isset($_SESSION['studentuniform_id']))
	 {
		 $studentuniform_id = $_SESSION['studentuniform_id'];
	 }
	...
	$studentuniform_data		=	array();
	$studentuniform_data		=	$db->fetch_studentuniform_full_details_by_id($studentuniform_id);
	...
	if(!empty($studentuniform_data))
	{	
		 
	$result_id					=	$studentuniform_data[0];
	$result_g_no				=	$studentuniform_data[1];
	$result_challan 			=	$studentuniform_data[2];
	$result_challan_image  		=	$studentuniform_data[3];
	$result_bill				=	$studentuniform_data[4];
	$result_bill_image			=	$studentuniform_data[5];
	$result_supplier			=	$studentuniform_data[6];
	$result_description			=	$studentuniform_data[7];
	$result_unit				=	$studentuniform_data[8];
	$result_received 			=	$studentuniform_data[9];
	$result_rejected	    	=	$studentuniform_data[10];
	$result_accepted			=	$studentuniform_data[11];
	$result_amount				=	$studentuniform_data[12];
	$result_total	 			=	$studentuniform_data[13];
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_studentuniform_full_details($description,$accepted,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Student Uniform Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Student Uniform Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Student Uniform Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Student Uniform Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="studentuniform-reports.php">Student Uniform Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-studentuniform-details.php">Student Uniform Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5> Student Uniform Details</h5>
                                                        <span>Please fill the Student Uniform Details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="studentuniform-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_studentsuniform_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-studentuniform-details.php?studentuniform-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-studentuniform-details.php?del_studentuniform_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
