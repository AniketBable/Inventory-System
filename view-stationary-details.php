...
<?php
	...
	$result_challan_image  		=	$stationary_data[3];
	$result_bill				=	$stationary_data[4];
	$result_bill_image			=	$stationary_data[5];
	$result_supplier			=	$stationary_data[6];
	$result_description			=	$stationary_data[7];
	$result_unit				=	$stationary_data[8];
	$result_received 			=	$stationary_data[9];
	$result_rejected	    	=	$stationary_data[10];
	$result_accepted			=	$stationary_data[11];
	$result_amount				=	$stationary_data[12];
	$result_total	 			=	$stationary_data[13];
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_stationary_full_details($description,$accepted,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Stationary Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
	...
	if(isset($_GET['del_stationary_id']))
	 {
		...
		$db->delete_stationary_details_by_id($delete_id);
...
<head>
    <title> Admin |   Stationary Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Stationary Details</h5>
                                            ...
                                            <ul class="breadcrumb-title b-t-default p-t-10">
												...
												<li class="breadcrumb-item"><a href="edit-stationary-details.php">Stationary Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
													 ...
													 <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_stationary_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/view-stationary-details.php?del_stationary_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
