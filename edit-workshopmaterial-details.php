...
<?php
	...
	$result_bill         		=	$workshopmaterial_data[3];
	$result_supplier			=	$workshopmaterial_data[4];
	$result_description			=	$workshopmaterial_data[5];
	$result_unit				=	$workshopmaterial_data[6];
	$result_received 			=	$workshopmaterial_data[7];
	$result_rejected	    	=	$workshopmaterial_data[8];
	$result_accepted			=	$workshopmaterial_data[9];
	$result_amount				=	$workshopmaterial_data[10];
	$result_total	 			=	$workshopmaterial_data[11];
	$result_date				=	$workshopmaterial_data[12];
	$result_time				=	$workshopmaterial_data[13];
	...
	if(isset($_POST['edit']))
	{
		...
		$total			=	$_POST['total'];
			...
			if($db->update_workshopmaterial_full_details_by_id($g_no,$challan,$bill,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$workshopmaterial_id))
			{
					  $common_msg	=	"Workshop Material Records Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Workshop Material Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Add Workshop Material Details</h5>
                                            ...
                                            <ul class="breadcrumb-title b-t-default p-t-10">
												...
												<li class="breadcrumb-item"><a href="edit-workshopmaterial-details.php">Edit Workshop Material</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="workshop-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
