	...
	if(isset($_GET['del_printingstationary_id']))
	 {
		...
		$db->delete_printingstationary_full_details_by_id($delete_id);
...
<head>
    <title>Inventory System | Printing Stationary Reports  </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Printing Stationary Reports</h5>
                                            <p class="text-muted m-b-10">You can view all Printing Stationary below..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="add-printingstationary-details.php">Add Printing Stationary</a>
                                                </li>
                                                  ...
                                                  <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_printingstationary_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/view-printingstationary-details.php?printingstationary-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">View</a></td>
																		...
																		<td><a href="/printingstationary-reports.php?del_printingstationary_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
