...
<?php
	...
	if(isset($_GET['del_computerperipherals_id']))
	 {
		$delete_id = $_GET['del_computerperipherals_id'];		
		
		$db->delete_computerperipherals_stock_details_by_id($delete_id);
		$common_msg	=	"computerperipherals record deleted successfully.";
	 }
	...
	{ 
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];	 
			...
			if($db->add_computerperipherals_full_details($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Computer Peripherals Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin |   Computer Peripherals  Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Computer Peripherals  Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Computer Peripherals  Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="computer&peripherals-reports.php">Computer Peripherals  Stock Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="view-computer&peripherals-details.php">Computer Peripherals  Stock Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5> Computer Peripherals Stock Details</h5>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="computerperipherals-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
													 	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
															<script type="text/javascript">
																  ...
																  $("#btnExport").click(function(e) {
																	...
																	a.download = 'Computer&Peripherals Report.xls';
																	a.click();
																  });
																});
															</script>
                                                        ...
                                                        <div class="dt-responsive table-responsive" id="table_wrapper">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_computerperipherals_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-computer&rperipherals-stock-details.php?computerperipherals-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-computer&peripherals-details.php?del_computerperipherals_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
