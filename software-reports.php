	...
	if(isset($_GET['del_software_id']))
	 {
		...
		$db->delete_software_full_details_by_id($delete_id);
...
<head>
    <title>Inventory System |  Software Reports  </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Software Reports</h5>
                                            <p class="text-muted m-b-10">You can view all Software below..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li>
                                                <li class="breadcrumb-item"><a href="add-software-details.php">Add Software</a>
                                                </li>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>All Software Details By Multi-Column Ordering</h5>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_software_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/view-software-details.php?software-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">View</a></td>
													
 																		<td><a href="/edit-software-details.php?software-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/software-reports.php?del_software_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	</tr>
																	<?php
																		$counter++;
																		}
