...
<?php
	...
	if(isset($_GET['del_equipments_id']))
	 {
		$delete_id = $_GET['del_equipments_id'];		
		
		$db->delete_equipments_stock_details_by_id($delete_id);
		$common_msg	=	"Equipments record deleted successfully.";
	 }
	
	 if(isset($_GET['equipments-id']))
	 {
		$equipments_id = $_GET['equipments-id'];		
		$_SESSION['equipments_id'] = $equipments_id;
	 }
	 else if(isset($_SESSION['equipments_id']))
	 {
		 $equipments_id = $_SESSION['equipments_id'];
	 }
	...
	$equipments_data		=	$db->fetch_equipments_full_details_by_id($equipments_id);
	...
	if(!empty($equipments_data))
	{	
		 
	$result_id					=	$equipments_data[0];
	$result_g_no				=	$equipments_data[1];
	$result_challan 			=	$equipments_data[2];
	$result_challan_image  		=	$equipments_data[3];
	$result_bill				=	$equipments_data[4];
	$result_bill_image			=	$equipments_data[5];
	$result_supplier			=	$equipments_data[6];
	$result_description			=	$equipments_data[7];
	$result_unit				=	$equipments_data[8];
	$result_received 			=	$equipments_data[9];
	$result_rejected	    	=	$equipments_data[10];
	$result_accepted			=	$equipments_data[11];
	$result_amount				=	$equipments_data[12];
	$result_total	 			=	$equipments_data[13];
	...
	{ 
		...
		$given_quantity	=	$_POST['given_quantity'];
			...
			if($db->add_equipments_full_details($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity))
			{
					 $common_msg	=	"Equipments Records added Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin |   Equipments Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">  Equipments Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Equipments Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="equipments-reports.php">Equipments Stock Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="view-equipments-details.php">Equipments Stock Details</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <span>Please fill the Equipments Details..</span>
                                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
																	...
																	<div class="j-row"> 	 
																		...
																		<!--<div class="j-span6 j-unit">
                                                                            <div class="j-input"> 
                                                                                ...
                                                                                <input type="text" name="remaining_quantity" required   id="remaining">
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="equipments-reports.php" class="btn btn-primary">Back</a>
                                                                </div>
													 ...
													 <div class="card-block">
													 	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
															<script type="text/javascript">
																  ...
																  $("#btnExport").click(function(e) {
																	...
																	a.download = 'Equipments Report.xls';
																	a.click();
																  });
																});
															</script>
                                                        ...
                                                        <div class="dt-responsive table-responsive" id="table_wrapper">
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
																<?php
																	$got_details	=	$db->fetch_full_equipments_details();
                                                                    ...
                                                                    <tr>
																		...
																		<td><a href="/edit-equipments-stock-details.php?equipments-id=<?php echo $got_id; ?>" target="_blank" class="Edit_option">Edit</a></td>
																			
																		<td><a href="/view-equipments-details.php?del_equipments_id=<?php echo $got_id; ?>" class="delete_option">Delete</a></td>
																	  </tr>
																	<?php
																		$counter++;
																		}
