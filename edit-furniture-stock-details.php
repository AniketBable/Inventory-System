...
<?php
	...
	$furniture_data		=	$db->fetch_furniture_stock_details_by_id($furniture_id);
	...
	$result_supply_order		=	$furniture_data[1];
	$result_bill				=	$furniture_data[2];
	$result_D_C					=	$furniture_data[3];
	$result_supplier			=	$furniture_data[4];
	$result_description			=	$furniture_data[5];
	$result_received			=	$furniture_data[6];
	$result_amount				=	$furniture_data[7];
	$result_total				=	$furniture_data[8];
	$result_department			=	$furniture_data[9];
	$result_staff_name			=	$furniture_data[10];
	$result_lab_no				=	$furniture_data[11];
	$result_date				=	$furniture_data[12];
	$result_given_quantity		=	$furniture_data[13];
	$result_remaining_quantity	=	$furniture_data[14];
	...
	if(isset($_POST['update-entry']))
	{
		...
		$remaining_quantity	=	$_POST['remaining_quantity'];
			...
			if($db->update_furniture_stock_details_by_id($supply_order,$bill,$D_C,$supplier,$description,$received,$amount,$total,$department,$staff_name,$lab_no,$date,$given_quantity,$remaining_quantity,$furniture_id))	
			{
					  $common_msg	=	"Furniture Stock Details Updated Successfully.";
			}
			else
			{
					$common_msg1	= "Failed";
...
<head>
    <title> Admin | Edit Furniture Stock Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Furniture Stock Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Furniture Stock Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="view-furniture-details.php">Furniture Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-furniture-stock-details.php">Edit Furniture Stock</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="j-wrapper j-wrapper-640">
                                                            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="j-pro" id="j-pro" enctype="multipart/form-data" >
                                                                ...
                                                                <div class="j-footer"> 
																	...
																	<a href="view-furniture-details.php" class="btn btn-primary">Back</a>
                                                                </div>
