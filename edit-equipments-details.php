...
<?php
	...
	$result_date				=	$equipments_data[14];
	$result_time				=	$equipments_data[15];
	...
	if(isset($_POST['edit']))
	{
		...
		{ 
			...
			$db->update_equipments_full_details_by_id($g_no,$challan,$challan_image_name,$bill,$bill_image_name,$supplier,$description,$unit,$received,$rejected,$accepted,$amount,$total,$equipments_id);	
			$common_msg	=	"Equipments Record Updated successfully.";
		}
...
<head>
    <title> Admin | Edit Equipments Details </title>
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Edit Equipments Details</h5>
                                            <p class="text-muted m-b-10">You can edit your Equipments Details..</p>
                                            <ul class="breadcrumb-title b-t-default p-t-10">
                                                <li class="breadcrumb-item">
                                                    <a href="dashboard.php"> <i class="fa fa-home"></i> </a>
                                                </li> 
                                                <li class="breadcrumb-item"><a href="equipments-reports.php">Equipments Reports</a>
                                                </li>
												<li class="breadcrumb-item"><a href="edit-equipments-details.php">Edit Equipments</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                                   ...
                                                                   <div class="j-row">
																		...
																		<div class="j-unit">
																			<div class="j-input">
																				...
																				<div class="col-sm-10">
																					<input  type="file" name="challanimg"  value="<?php echo $result_challan_image ; ?>"><?php echo $result_challan_image ; ?></input>
																		...
																		<div class="j-unit">
																			<div class="j-input">
																				...
																				<div class="col-sm-10">
																					<input  type="file" name="billimg" value="<?php echo $result_bill_image ?> " ><?php echo $result_bill_image ?>  </input>
																					<span class="messages"></span>
